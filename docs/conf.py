...
latex_documents = [
  (master_doc, 'qgrid.tex', u'qgrid Documentation',
...
man_pages = [
    (master_doc, 'qgrid', u'qgrid Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'qgrid', u'qgrid Documentation',
   author, 'qgrid', 'One line description of project.',
   'Miscellaneous'),
]
